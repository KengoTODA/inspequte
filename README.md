...
- Java 21 remains the primary test-harness JDK.
- A separate CI lane verifies Java 26 class files (major version 70).
...
See [Java class-file compatibility](docs/java-compatibility.md) for the fixture,
parser policy, and process for adding future Java lanes.
