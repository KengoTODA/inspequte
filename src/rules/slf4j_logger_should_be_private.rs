...
mod tests {
    ...
    fn analyze_sources(sources: Vec<SourceFile>) -> Vec<String> {
        ...
        output
            .results
            .iter()
            .filter(|result| result.rule_id.as_deref() == Some("SLF4J_LOGGER_SHOULD_BE_PRIVATE"))
...
"#
    ...
    #[test]
    fn slf4j_logger_should_be_private_reports_non_private() {
...
"#,
    ...
    #[test]
    fn slf4j_logger_should_be_private_allows_private() {
        let sources = slf4j_sources(
            r#"
package com.example;
import org.slf4j.Logger;
