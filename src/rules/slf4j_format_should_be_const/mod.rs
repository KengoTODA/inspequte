                    ...
                    if is_slf4j_logger_call(call) {
                        if let Some(format_index) = format_index(param_types) {
                            ...
                            if format_arg != ValueKind::ConstString {
                                let message =
                                    result_message("SLF4J format string should be constant");
...
"#
    ...
    #[test]
    fn slf4j_format_should_be_const_reports_non_const() {
...
"#,
    ...
    #[test]
    fn slf4j_format_should_be_const_handles_marker_and_message_only() {
        let sources = slf4j_sources(
            r#"
package com.example;
import org.slf4j.Logger;
